...
// 🌟 Secure query via Prepared Statements to fetch currently saved recipes
$stmt = mysqli_prepare($conn, "
    ...
    ORDER BY s.id DESC
");
$bind_user_id = (string)$user_id;
mysqli_stmt_bind_param($stmt, "s", $bind_user_id);
...
<head>
  <meta charset="UTF-8">
  <title>Saved Recipes - TheFoodies</title>
  ...
  <main class="recipes-container">
    ...
    <div class="recipes-grid">
      <?php if(mysqli_num_rows($result) > 0): ?>
        ...
        <?php endwhile; ?>
      <?php else: ?>
        <p style="color:#666; font-style:italic; grid-column:1 / -1; font-size:1rem;">No saved recipes yet! Go save some. 😄</p>
      <?php endif; ?>
    </div>
  </main>
